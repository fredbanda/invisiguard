...
export const SignedIn = () => {
  ...
  return (
    <div className="relative">
        ...
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="relative ml-3">
            ...
            >
              ...
              <Image className="h-8 w-8 rounded-full" src={userImage} alt="User Profile" width={40} height={40} />
            </button>
            ...
            {userMenuOpen && (
              <div
                ...
                role="menu"
              >
                <h4 className="text-center text-bold itali">{session?.user?.name}</h4>
                <Link href="/dashboard/{user.id}/details" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                  Your Dashboard
                </Link>
      ...
      {mobileMenuOpen && (
        <div
          className="absolute top-16 left-0 z-20 w-full bg-gray-800 text-white"
          id="mobile-menu"
        >
          <div className="space-y-1 px-2 pb-3 pt-2">
            <Link href="/dashboard" className="block rounded-md px-3 py-2 text-base font-medium bg-gray-900">
              Dashboard
            </Link>
            <Link
              href="/dashboard/services"
